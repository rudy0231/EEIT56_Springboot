        ...
        <nav class="navbar navbar-expand-lg navbar-light">
          <div class="container">
            ...
            <a class="navbar-brand logo_h" href="index.html"
              ><img src="front_index/img/logo.png" alt=""
            /></a>
            <button
...
<!--                     </li> -->
  ...
  <div class="rounded-circle border border-secondary" style="width: 50px; height: 50px; overflow: hidden;">
       <a href="/profile"> 
    <img src="/t6_10_showNowImg.controller" class="w-100 h-100" alt="找不到用戶圖">
    	</a>
  </div>
   <div class=" border-secondary" style="width: 100px; height: 40px; overflow: hidden;">
   <a href="/profile"> 
    <img src="/t6_10_showStatusImg.controller" class="w-100 h-100" alt="找不到狀態圖">
	</a>
  </div>
  <span class="ml-2" >  
            ...
            <div class="owl-carousel active_course">
                ...
                <div class="course_content">
                  ...
                  >
                    <div class="authr_meta">
                      <img src="front_index/img/courses/author1.png" alt="" />
              ...
              <div class="single_course">
                ...
                <div class="course_content">
                  ...
                  >
                    <div class="authr_meta">
                      <img src="front_index/img/courses/author2.png" alt="" />
                      <span class="d-inline-block ml-2">Cameron</span>
                    </div>
                    <div class="mt-lg-0 mt-3">
                      <span class="meta_info mr-4">
              ...
              <div class="single_course">
                ...
                <div class="course_content">
                  ...
                  >
                    <div class="authr_meta">
                      <img src="front_index/img/courses/author3.png" alt="" />
                      <span class="d-inline-block ml-2">Cameron</span>
                    </div>
                    <div class="mt-lg-0 mt-3">
                      <span class="meta_info mr-4">
          ...
          <div class="col-lg-12">
            <div class="text-center pt-lg-5 pt-3">
              <a href="#" class="event-link">
                View All Event <img src="front_index/img/next.png" alt="" />
              </a>
            </div>
          </div>
        </div>
