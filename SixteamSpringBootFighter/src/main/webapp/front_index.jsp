<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		...
		<head>
			...
			<link rel="icon" href="front_index/img/favicon.png" type="image/png" />
			<title>神明便利店外</title>
			<!-- Bootstrap CSS -->
		...
		<body onload="myFunction()">
				...
				<div class="main_menu">
					...
					<nav class="navbar navbar-expand-lg navbar-light">
						<div class="container">
							...
							<a class="navbar-brand logo_h" href="index.html"><img src="front_index/img/logo.png"
									alt="" /></a>
							...
							<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
								<ul class="nav navbar-nav menu_nav ml-auto">
									<li class="nav-item active">
										<a class="nav-link" href="index.html">登入</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="about-us.html">後台系統</a>
									</li>
									<li class="nav-item submenu dropdown">
										<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"
											role="button" aria-haspopup="true" aria-expanded="false">購物商城</a>
										<ul class="dropdown-menu">
											<li class="nav-item">
												<a class="nav-link" href="courses.html">運勢小物</a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="course-details.html">改運課程</a>
											</li>
											<!--                     <li class="nav-item"> -->
									...
									<li class="nav-item submenu dropdown">
										<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"
											role="button" aria-haspopup="true" aria-expanded="false">功能導覽</a>
										<ul class="dropdown-menu">
											<li class="nav-item">
												<a class="nav-link" href="blog.html"></a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="single-blog.html">近期活動</a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="single-blog.html">信徒論壇</a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="single-blog.html">姻緣配對</a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="single-blog.html">住宿訂房</a>
											</li>
										</ul>
									</li>
									<li class="nav-item">
									...
									<li class="nav-item">
										<div class="d-flex align-items-center">
											...
											<div class="rounded-circle border border-secondary"
												...
												<a href="/profile">
													<img src="/t6_10_showNowImg.controller" class="w-100 h-100"
														alt="找不到用戶圖">
												</a>
											</div>
											<div class=" border-secondary"
												style="width: 100px; height: 40px; overflow: hidden;">
												<a href="/profile">
													<img src="/t6_10_showStatusImg.controller" class="w-100 h-100"
														alt="找不到狀態圖">
												</a>
											</div>
											<span class="ml-2">
												<!-- <a href="/profile">我的頁面</a> -->
											</span>
										</div>
									</li>
								</ul>
							...
							<div class="owl-carousel active_course">
								<div class="single_course">
									<div class="course_head">
										<img class="img-fluid" src="front_index/img/courses/c1.jpg" alt="" />
									</div>
									<div class="course_content">
										<span class="price">$25</span> <span
											class="tag mb-4 d-inline-block">design</span>
										<h4 class="mb-3">
											<a href="course-details.html">Custom Product Design</a>
										</h4>
										<p>One make creepeth man bearing their one firmament won't
											fowl meat over sea</p>
										<div
											class="course_meta d-flex justify-content-lg-between align-items-lg-center flex-lg-row flex-column mt-4">
											<div class="authr_meta">
												<img src="front_index/img/courses/author1.png" alt="" /> <span
													class="d-inline-block ml-2">Cameron</span>
											</div>
											<div class="mt-lg-0 mt-3">
												<span class="meta_info mr-4"> <a href="#"> <i
															class="ti-user mr-2"></i>25
													</a>
												</span> <span class="meta_info"><a href="#"> <i
															class="ti-heart mr-2"></i>35
													</a></span>
											</div>
										</div>
									</div>
								...
								<div class="single_course">
									<div class="course_head">
										<img class="img-fluid" src="front_index/img/courses/c2.jpg" alt="" />
									</div>
									<div class="course_content">
										<span class="price">$25</span> <span
											class="tag mb-4 d-inline-block">design</span>
										...
										<div
											class="course_meta d-flex justify-content-lg-between align-items-lg-center flex-lg-row flex-column mt-4">
											<div class="authr_meta">
												<img src="front_index/img/courses/author2.png" alt="" /> <span
													class="d-inline-block ml-2">Cameron</span>
											</div>
											<div class="mt-lg-0 mt-3">
												<span class="meta_info mr-4"> <a href="#"> <i
								...
								<div class="single_course">
									<div class="course_head">
										<img class="img-fluid" src="front_index/img/courses/c3.jpg" alt="" />
									</div>
									<div class="course_content">
										<span class="price">$25</span> <span
											class="tag mb-4 d-inline-block">design</span>
										...
										<div
											class="course_meta d-flex justify-content-lg-between align-items-lg-center flex-lg-row flex-column mt-4">
											<div class="authr_meta">
												<img src="front_index/img/courses/author3.png" alt="" /> <span
													class="d-inline-block ml-2">Cameron</span>
											</div>
											<div class="mt-lg-0 mt-3">
												<span class="meta_info mr-4"> <a href="#"> <i
								...
								<form class="form_area" id="myForm" action="mail.html" method="post">
									<div class="row">
										<div class="col-lg-12 form_group">
											<input name="name" placeholder="Your Name" required="" type="text" /> <input
												name="name" placeholder="Your Phone Number" required="" type="tel" />
					...
					<div class="row justify-content-center d-flex align-items-center">
						<div class="col-lg-3 col-md-6 col-sm-12 single-trainer">
							<div class="thumb d-flex justify-content-sm-center">
								<img class="img-fluid" src="front_index/img/trainer/t1.jpg" alt="" />
							</div>
						...
						<div class="col-lg-3 col-md-6 col-sm-12 single-trainer">
							<div class="thumb d-flex justify-content-sm-center">
								<img class="img-fluid" src="front_index/img/trainer/t2.jpg" alt="" />
							</div>
							<div class="meta-text text-sm-center">
								<h4>David Cameron</h4>
								<p class="designation">Sr. web designer</p>
						...
						<div class="col-lg-3 col-md-6 col-sm-12 single-trainer">
							<div class="thumb d-flex justify-content-sm-center">
								<img class="img-fluid" src="front_index/img/trainer/t3.jpg" alt="" />
							</div>
							<div class="meta-text text-sm-center">
								<h4>Jain Redmel</h4>
						...
						<div class="col-lg-3 col-md-6 col-sm-12 single-trainer">
							<div class="thumb d-flex justify-content-sm-center">
								<img class="img-fluid" src="front_index/img/trainer/t4.jpg" alt="" />
							</div>
							<div class="meta-text text-sm-center">
								<h4>Nathan Macken</h4>
								<p class="designation">Sr. web designer</p>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-6 col-md-6">
							<div class="single_event position-relative">
								<div class="event_thumb">
									<img src="front_index/img/event/e1.jpg" alt="" />
								</div>
								<div class="event_details">
									...
									<p>One make creepeth man for so bearing their firmament won't
										fowl meat over seas great</p>
						...
						<div class="col-lg-6 col-md-6">
							<div class="single_event position-relative">
								<div class="event_thumb">
									<img src="front_index/img/event/e2.jpg" alt="" />
								</div>
								<div class="event_details">
									<div class="d-flex mb-4">
										<div class="date">
						...
						<div class="col-lg-12">
							<div class="text-center pt-lg-5 pt-3">
								<a href="#" class="event-link"> View All Event <img src="front_index/img/next.png"
										alt="" />
								</a>
							</div>
						</div>
					...
					<div class="row">
						<div class="testi_slider owl-carousel">
							<div class="testi_item">
								<div class="row">
									<div class="col-lg-4 col-md-6">
										<img src="front_index/img/testimonials/t1.jpg" alt="" />
									</div>
									<div class="col-lg-8">
							...
							<div class="testi_item">
								<div class="row">
									<div class="col-lg-4 col-md-6">
										<img src="front_index/img/testimonials/t2.jpg" alt="" />
									</div>
									<div class="col-lg-8">
										<div class="testi_text">
											<h4>Davil Saden</h4>
				...
				<div class="container">
					...
					<div class="row footer-bottom d-flex justify-content-between">
						...
						<div class="col-lg-4 col-sm-12 footer-social">
							<a href="#"><i class="ti-facebook"></i></a> <a href="#"><i class="ti-twitter"></i></a> <a
								href="#"><i class="ti-dribbble"></i></a>
			...
			<script src="front_index/vendors/nice-select/js/jquery.nice-select.min.js"></script>
