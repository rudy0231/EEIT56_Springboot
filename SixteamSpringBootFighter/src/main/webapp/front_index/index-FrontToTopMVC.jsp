						...
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item submenu dropdown"><a href="#"
								...
								<ul class="dropdown-menu">
									...
									<li class="nav-item"><a class="nav-link"
										href="single-blog.html">信徒論壇</a></li>
									<li class="nav-item"><a class="nav-link"
							...
							<!-- 							</a>  -->
							<li class="nav-item" style="margin-top:16px"><a href="showshoppingcart.controller"
								class="btn border"> <i class="fas fa-shopping-cart"
									style="color: #fdc632"></i> <c:choose>
								...
								<c:choose>
									<c:when test="${not empty LoginOK }">
										<li class="nav-item submenu dropdown" style="margin-top:-2px;margin-right:-50px"><a href="#"
								class="nav-link dropdown-toggle" data-toggle="dropdown"
								role="button" aria-haspopup="true" aria-expanded="false"
								...
								<ul class="dropdown-menu" style="border-radius:;background-color:">
									<li class="nav-item"><a class="nav-link" href="blog.html"></a>
									</li>
									<li class="nav-item"><a class="nav-link"
										href="/loginToProfile">基本資料</a></li>
									<li class="nav-item"><a class="nav-link"
										href="/showAllClass.controller">課程訂單紀錄</a></li>
									<li class="nav-item"><a class="nav-link"
										href="/EventRegist">已報名活動</a></li>
									<li class="nav-item"><a class="nav-link"
										href="/favorite">我的最愛活動</a></li>
									<li class="nav-item"><a class="nav-link"
										href="single-blog.html">訂房紀錄</a></li>
									<li class="nav-item"><a class="nav-link"
										href="single-blog.html">發文紀錄</a></li>
									<li class="nav-item"><a class="nav-link"
										href="single-blog.html">配對紀錄</a></li>
									<li class="nav-item"><a class="nav-link"
										href="single-blog.html">物品訂單紀錄</a></li>									
								</ul></li>
									</c:when>
									<c:otherwise>
										<li class="nav-item submenu dropdown" style="margin-top:15px;margin-right:-50px"><a id="UserPic" href="#"
								class="nav-link dropdown-toggle" data-toggle="dropdown"
								role="button" aria-haspopup="true" aria-expanded="false"
								style="color: #fdc632; font-size: 18px; font-weight: bold"><img
									src="/t6_10_showNowImg.controller" class="rounded-circle"
