                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">管理者登入系統</h3>
                                </div>
                                <div class="card-body">
                                    <form action="t6_21checklogin.controller" method="post">
                                    	<div>帳號:<span color="#FF0000">${errors.name}</span>
                                    	</div>
                                        ...
                                        <div>密碼:<span color="#FF0000">${errors.pwd}</span></div>
                                        <div class="form-floating mb-3">
                                        ...
                                        <span color="#FF0000">${errors.msg}</span>
                                ...
                                <div class="card-footer text-center py-3">
                                    <div class="small"><a href="register.html">還沒有帳號? 註冊一個吧!</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
