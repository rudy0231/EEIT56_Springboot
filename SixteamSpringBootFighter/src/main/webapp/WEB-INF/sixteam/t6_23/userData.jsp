<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <body>
            ...
            <div class="div1">
                <form action="<c:url value='/t6_23/saveUserData.controller' />" method="post"
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <select name="age" id="age">
                                        <option value="${bean.age}">${bean.age}</option>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <select name="gender" id="gender">
                                        <option value="${bean.sex}">${bean.sex}</option>
...
<%--                                         <option value="${place}">請選擇區域</option> --%>
<!--                                     </select> -->
                                </td>
                            </tr>
                            <tr>
...
<%--                                         <option value="${bean.religion}">請由左方選取教別</option> --%>
<!--                                     </select> -->
          <select name="religion" id="religion">
                                        <option value="${bean.religion }">${bean.religion }
                                        <option value="道教">道教
                                        <option value="佛教">佛教
                            ...
                            <tr>
                                ...
                                <td align="left">
<!--                                     分類: -->
                                    <select onchange="changeprofession(this.selectedIndex);" name="profession">
                                        <option value="${bean.profession}">${bean.profession}
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <select name="star_sign" id="star_sign">
                                        <option value="${bean.star}">${bean.star}</option>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <select name="blood_type" id="blood_type">
                                        <option value="${bean.bloobtype}">${bean.bloobtype}</option>
                            ...
                            <tr>
                                <td>個人line QRcode</td>
                                <td>
                                    <input type="file" name="line_qrcode" id="" accept='.png,.jpg'>
                                    <span style="color:red;">${errors.eqrcode }</span>
                                </td>
                            </tr>
                            <tr>
                                <td>簡介:</td>
                                <td><textarea name="emotion" id="" cols="30" rows="4" maxlength="50"
                                        placeholder="寫點東西讓別人能夠認識你，或者是告訴其他人你想認識甚麼樣的人，預設為\想認識同宗教的人\">${bean.emotion}</textarea>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <ul style="list-style-type:none">
                        <li>
                            <div class="onoffswitch">
                                <div>
                                    配對功能:
                                    <label class="switch">
                                        <input type="checkbox" name="checkboxStatus_1" value='off' checked>
                                        <span class="slider"></span>
                                    </label>
                                    <input type="hidden" name="checkboxVaule_1" value="on">
                                </div>
                            </div>
                        ...
                        <div class="onoffswitch">
                            <div>
                                配對功能:
                                <label class="switch">
                                    <input type="checkbox" name="checkboxStatus_2" value='off'>
                                    <span class="slider"></span>
                                </label>
                                <input type="hidden" name="checkboxVaule_2" value="off">
                            </div>
                        </div>
                    ...
                    <li>
                        <div class="onoffswitch">
                            <div>
                                配對功能:
                                <label class="switch">
                                    <input type="checkbox" name="checkboxStatus_3" value='off'>
                                    <span class="slider"></span>
                                </label>
                                <input type="hidden" name="checkboxVaule_3" value="off">
                            </div>
                        </div>
                    ...
                    <input class="btn btn-success btn-user " type="submit" value="送出">
                    <!-- <input type="reset" value="清除"> -->
                    <!-- <input type="button" value="取消" onclick=""> -->
                </form>
                <form action="<c:url value='/t6_23/go.controller' />">
                    <button class="btn btn-primary goIndex" type="submit">反回首頁</button>
                </form>
            </div>
            ...
            <script>
                ...
                $(function () {
                    // val="on" 且 checked 可以預設為開 
                    const checkbox1_Status = $('input[name="checkboxStatus_1"]');
                    const checkbox1_Vaule = $('input[name="checkboxVaule_1"]');
                    checkbox1_Status.change(function () {
                        if (checkbox1_Status.is(':checked')) {
                            // Checkbox is checked (ON)
                            checkbox1_Vaule.val('on');
                        } else {
                            // Checkbox is not checked (OFF)
                            checkbox1_Vaule.val('off');
                        }
                    });
                    // var isChecked = '${bean.match}'; // 從資料庫中獲取的值
                    // if (isChecked == 'true') {
            ...
            <script>
                $(function () {
                    // val="on" 且 checked 可以預設為開 
                    const checkbox2_Status = $('input[name="checkboxStatus_2"]');
                    const checkbox2_Vaule = $('input[name="checkboxVaule_2"]');
                    checkbox2_Status.change(function () {
                    
                                            if (checkbox2_Status.is(':checked')) {
                            // Checkbox is checked (ON)
                            checkbox2_Vaule.val('on');
                        } else {
                            // Checkbox is not checked (OFF)
                            checkbox2_Vaule.val('off');
                        }
                    });
                    // var isChecked = '${bean.match}'; // 從資料庫中獲取的值
                    // if (isChecked == 'true') {
            ...
            <script>
                $(function () {
                    // val="on" 且 checked 可以預設為開 
                    const checkbox3_Status = $('input[name="checkboxStatus_3"]');
                    const checkbox3_Vaule = $('input[name="checkboxVaule_3"]');
                    checkbox3_Status.change(function () {
                        if (checkbox3_Status.is(':checked')) {
                            // Checkbox is checked (ON)
                            checkbox3_Vaule.val('on');
                        } else {
                            // Checkbox is not checked (OFF)
                            checkbox3_Vaule.val('off');
                        }
                    });
                })
            </script>
