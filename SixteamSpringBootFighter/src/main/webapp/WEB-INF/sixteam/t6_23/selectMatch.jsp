<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<head>
		<meta charset="UTF-8">
		<title>配對</title>
		<link rel="stylesheet" href="${pageContext.request.contextPath}/front_index/css/bootstrap.css" />
		<link rel="stylesheet" href="${pageContext.request.contextPath}/front_index/css/flaticon.css" />
		<link rel="stylesheet" href="${pageContext.request.contextPath}/front_index/css/themify-icons.css" />
		<!-- <link rel="stylesheet" href="${pageContext.request.contextPath}/front_index/vendors/owl-carousel/owl.carousel.min.css" /> -->
		<link rel="stylesheet"
			href="${pageContext.request.contextPath}/front_index/vendors/nice-select/css/nice-select.css" />
		<!-- main css -->
		<link rel="stylesheet" href="${pageContext.request.contextPath}/front_index/css/style.css" />
		...
		<!-- <script type="text/javascript">
			...
			function load(x) {
				$.ajax({
					type: 'post',
					url: '/t6_23/findMatch.controller',
					dataType: 'JSON',
					success: (result) => {
						...
						var buttom = "<input type='button' value='刷新' onclick='reload(" + x + ");'>";
						data1.append(buttom);
	...
	<body>
		...
		<script src="${pageContext.request.contextPath}/front_index/js/jquery-3.2.1.min.js"></script>
		<script src="${pageContext.request.contextPath}/front_index/js/popper.js"></script>
		<script src="${pageContext.request.contextPath}/front_index/js/bootstrap.min.js"></script>
		<script
			src="${pageContext.request.contextPath}/front_index/vendors/nice-select/js/jquery.nice-select.min.js"></script>
		<script src="${pageContext.request.contextPath}/front_index/vendors/owl-carousel/owl.carousel.min.js"></script>
		<script src="${pageContext.request.contextPath}/front_index/js/owl-carousel-thumb.min.js"></script>
		<script src="${pageContext.request.contextPath}/front_index/js/jquery.ajaxchimp.min.js"></script>
		<script src="${pageContext.request.contextPath}/front_index/js/mail-script.js"></script>
		<!--gmaps Js-->
		<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCjCGmQ0Uq4exrzdcL6rvxywDDOvfAu6eE"></script>
		<script src="${pageContext.request.contextPath}/front_index/js/gmaps.min.js"></script>
		<script src="${pageContext.request.contextPath}/front_index/js/theme.js"></script>
				...
				$.ajax({
					...
					success: (result) => {
						...
						$.each(result, (i, n) => {
							...
							var div = "<div class='col-md-12' id='" + n.id + "' onclick='scanMatcher(" + n.id + ")'><div class=''><div class=''><div class=''><img height='200' width='140' class='img-fluid' src='/t6_23/getImages.controller/" + n.id + "' /></div>"
								+ "<div class=''><span class='uname'>" + n.name + "</span> <span class='tag mb-4 d-inline-block'>" + n.religion + "</span>" + "<h4 class='mb-3'><a href='/t6_23/scanMatcherUser.controller/" + n.id + "'>" + n.emotion + "</a></h4>" + "<p>星座:" + n.star + "</p>" + "<p>血型:" + n.bloobtype + "</p>" + "<a href='/t6_23/scanMatcherUser.controller/" + n.id + "'>瀏覽資料</a>"
								// + "<button style='float: right' id='" + n.id + "' class='btn btn-sm text-dark p-0 goMatch' onclick='goMatch(" + n.id + ")'>進行配對</button>"
								+ "</div></div></div></div>";
							if (i < 9) {
								data1.append(div2);
