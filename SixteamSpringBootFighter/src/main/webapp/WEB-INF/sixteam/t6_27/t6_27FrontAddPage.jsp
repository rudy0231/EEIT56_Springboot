...
<body>
	...
	<div class="card mb-4">
		...
		<div class="card-body">
			...
			<form action="<c:url value='/t6_27addFrontPost.controller'/>"
				...
				<div class="form-group row">
					...
					<div class="col-sm-11">
						<select id="postboard" name="board" class="post-select"
							required="required">
							<option>星座運勢</option>
							<option>紫微斗數</option>
							<option>塔羅愛情</option>
				...
				<div class="form-group row">
					...
					<div class="col-sm-11">
						<input type="text" name="title" class="post-select" id="posttitle"
							required="required" />
					</div>
				</div>
				...
				<input type="hidden" name="good" readonly="readonly" /> <input
					type="hidden" name="bad" readonly="readonly" />


				<div class="form-group row">
					<label for="inputPassword" class="col-sm-2 col-form-label"
						id="post-label">文章內容</label>
					<textarea name="content" id="editor" class="postcontent"></textarea>
				</div>
				<div>
