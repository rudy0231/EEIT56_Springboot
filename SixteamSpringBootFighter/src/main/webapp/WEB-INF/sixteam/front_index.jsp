...
.box_fixed {
	width: 150px;
	height: 300px;
	background-color: rgba(92, 92, 61, 0.8);
	position: fixed;
	right: 1%;
	bottom: 20%;
	border: solid;
			...
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<div class="single_feature">
						...
						<div class="desc">
							<h4 class="mt-3 mb-2">台灣繞境活動一覽</h4>
							<p>全台灣的繞境活動都為您整理好了!</p>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single_feature">
						...
						<div class="desc">
							<h4 class="mt-3 mb-2">最好的改運老師都聚集在這</h4>
							<p>扭轉命運就靠自己，改運密技不私藏</p>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single_feature">
						...
						<div class="desc">
							<h4 class="mt-3 mb-2">建立信徒間的溝通橋樑</h4>
							<p>在這裡找到志同道合的朋友一起討論信仰吧!</p>
						</div>
					</div>
				</div>
			</div>
							...
							<div class="row">
								<div class="col-lg-12 form_group">
									<input name="name" placeholder="Your Name" required=""
										...
										placeholder="Your Phone Number" required="" type="tel" /> <input
			...
			<c:forEach var="act" items="${actives}">
				<div class="col-lg-3 col-md-6 col-sm-12 single-trainer ">
					<div class="thumb d-flex justify-content-sm-center act">
						<img class="img-fluid" src="actives/toImg/${act.activeID}" alt="" style="max-width: 263px; max-height: 223px;"/>
					</div>
					<div class="meta-text text-sm-center ">
						...
						<div class="mb-4">
							<p>									開始時間:${act.activeStartDate}<br>活動地點:${act.activeLocation}
</p>
						</div>
			...
			<div class="row">
				...
				<div class="col-lg-12">
					<div class="text-center pt-lg-5 pt-3">
						<a href="#" class="event-link"> View All Event <img
							src="front_index/img/next.png" alt="" />
						</a>
					</div>
				</div>
			</div>
