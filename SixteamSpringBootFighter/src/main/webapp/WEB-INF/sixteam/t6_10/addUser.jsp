 mj8<%@ page import="sixteam.t6_10.model.*"%>
...
<%-- 		action='<c:url value='/t6_10_doAddUser.controller' />'  --%>
		action='' 
...
<!--                 <th>會員圖片</th> -->
                <th ><span class="fa-solid fa-image"></span>當前圖片</th>
     				...
     				<td>
                    <input type='text' name='username' id='username' placeholder='請輸入帳號' value="" required/>
                    <br>
                    <span id="response"></span>
                    </td>
										<td><input type="password" name="password" placeholder='請輸入密碼' value="" required></td>
										
										<td><input type='email' name='email' placeholder='請輸入Email' value="" required/></td>
										
										<td>
											<img id="preImg" height='80' width='80' 
...
<!-- 											<button class="btn btn-primary btn-user btn-block" id="addUser"> -->
											<button class="btn btn-success btn-user btn-block" id="addUser">
